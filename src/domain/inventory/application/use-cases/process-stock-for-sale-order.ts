...
interface ProcessStockForSaleOrderRequest {
  saleOrder: SaleOrder;
}

type ProcessStockForSaleOrderResponse = Either<
  ResourceNotFoundError | InsufficientStockError,
  { productsToUpdate: Product[] }
>;

export class ProcessStockForSaleOrderUseCase {
  constructor(private productsRepository: ProductsRepository) {}

  async execute({
    saleOrder,
  }: ProcessStockForSaleOrderRequest): Promise<ProcessStockForSaleOrderResponse> {
